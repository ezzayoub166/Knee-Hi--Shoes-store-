...
public class CBTabBarButton: UIControl {
    ...
    override public var tintColor: UIColor! {
        didSet {
            ...
            tabBg.backgroundColor = tintColor.withAlphaComponent(1)
        }
    }
    ...
    private let bgHeight: CGFloat = 35
    ...
    private func fold(animationDuration duration: Double = 0.0) {
        ...
        UIView.transition(with: tabImage, duration: duration, options: [.transitionCrossDissolve], animations: {
            self.tabImage.tintColor = "B8B7B7".color_//.black
        }, completion: nil)
    ...
    override public func layoutSubviews() {
        ...
        tabBg.layer.cornerRadius = 8//tabBg.bounds.height / 2.0
    }
}
