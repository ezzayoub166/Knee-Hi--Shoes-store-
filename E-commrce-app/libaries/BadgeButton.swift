...
//  Volo
//
//  Created by iosMaher on 6/24/19.
...
extension UIBarButtonItem {
    ...
    private func addBadge(text: String, withOffset offset: CGPoint = CGPoint.zero, andColor color: UIColor = UIColor.white, andFilled filled: Bool = true, andFontSize fontSize: CGFloat = 13)
    {
