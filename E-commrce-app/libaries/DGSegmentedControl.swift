...
@IBDesignable class DGSegmentedControl: UIControl {
    ...
    @IBInspectable var border_Color : UIColor = UIColor(red: 0.788, green: 0.788, blue: 0.788, alpha: 1.00) {
        didSet {
            self.setUnderline(ofColor: border_Color, andSize: borderSize)
        }
    }
...
//        UIView.animate(withDuration: 0.5, delay: 0.0, usingSpringWithDamping: 0.1, initialSpringVelocity: 0.8, options: UIView.AnimationOptions.allowAnimatedContent, animations: {
