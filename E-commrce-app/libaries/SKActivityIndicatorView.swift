...
public class SKActivityIndicator: NSObject {
    ...
    fileprivate var spinnerBarStyle        : UIBarStyle             = .default
...
//        }
    ...
    fileprivate func configureActivityIndicator(withStatusMessage message: String, isUserInteractionEnabled userInteractionStatus: Bool) {
        ...
        if activityIndicatorView == nil {
            ...
            activityIndicatorView!.barStyle = spinnerBarStyle
    ...
    fileprivate func configureActivityIndicatorSize() {
        ...
        var widthHUD: CGFloat = 80
        var heightHUD: CGFloat = 80
...
//    public static func setDarkMode() {
////        self.shared.spinnerBarStyle = .black
//        self.shared.statusTextColor = UIColor.white
//        self.shared.spinnerColor = UIColor.white
//    }
//
//    public static func setLightMode() {
////        self.shared.spinnerBarStyle = .default
//        self.shared.statusTextColor = self.shared.statusTextColor
//        self.shared.spinnerColor = self.shared.spinnerColor
//    }
}
